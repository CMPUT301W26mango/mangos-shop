...
public class AllRolesTest {
    ...
    public void testAdminRoleInitialization() {
        ...
        Admin paramAdmin = new Admin("AdminJohn", "john@admin.com", "111", "asdabasd232313");
    ...
    public void testOrganizerRoleInitialization() {
        ...
        Organizer paramOrganizer = new Organizer("OrganzierJohn", "OrgJohn@org.com", "222", "asdbsdf3243");
    ...
    public void testEntrantRoleInitialization() {
        ...
        Entrant paramEntrant = new Entrant("EntrantJohn", "EntrantJohn@entrant.com", "333", "asd3bw2303");
